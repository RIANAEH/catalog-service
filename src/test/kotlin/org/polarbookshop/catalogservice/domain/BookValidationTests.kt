...
class BookValidationTests {
    ...
    fun `when isbn is blank then validation fails`() {
        val book = Book(isbn = "", title = "Title", author = "Author", price = 9.90, publisher = "Publisher")
        val violations = validator.validate(book)
    ...
    fun `when isbn format is invalid then validation fails`() {
        val book = Book(isbn = "123ABC456", title = "Title", author = "Author", price = 9.90, publisher = "Publisher")
        val violations = validator.validate(book)
    ...
    fun `when isbn is valid 13 digits then validation succeeds`() {
        val book = Book(isbn = "1234567890123", title = "Title", author = "Author", price = 9.90, publisher = "Publisher")
        val violations = validator.validate(book)
        assertThat(violations).isEmpty()
    }
    ...
    fun `when title is blank then validation fails`() {
        val book = Book(isbn = "1234567890", title = "", author = "Author", price = 9.90, publisher = "Publisher")
        val violations = validator.validate(book)
        assertThat(violations).hasSize(1)
    ...
    fun `when author is blank then validation fails`() {
        val book = Book(isbn = "1234567890", title = "Title", author = "", price = 9.90, publisher = "Publisher")
        val violations = validator.validate(book)
        assertThat(violations).hasSize(1)
    ...
    fun `when price is zero then validation fails`() {
        val book = Book(isbn = "1234567890", title = "Title", author = "Author", price = 0.0, publisher = "Publisher")
        val violations = validator.validate(book)
        assertThat(violations).hasSize(1)
